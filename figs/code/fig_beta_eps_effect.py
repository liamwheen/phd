...
betas_plot = axs[0].plot(np.sin(np.linspace(-np.pi/2,np.pi/2,betas.shape[1])),betas.T,linewidth=3)
epss_plot = axs[2].plot(np.linspace(-90,90,epss.shape[1]),epss.T,linewidth=3)
