...
class Budyko:
    ...
    def milanko_update(self, t):
        self.eps = 0.0167#self.eps_func(t/year2sec/1000)
        self.beta = 0.4091#self.beta_func(t/year2sec/1000)
    ...
    def animate(self):
        ...
        self.ax.set_xlabel('$y = \sin(\\varphi$)')
