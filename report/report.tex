...
also rotate clockwise around the orbit, starting summer in the northern
hemisphere earlier.
...
frequencies is shown to change depending on the timescale over which the data
is analysed. 
\begin{figure}[h]
  \centering
...
legend. The two higher frequencies, at 0.0080\,kyr$^{-1}$ and
...
frequency peak at 0.0023 can again be explained by interference between the
other two frequencies, as we see the beat frequency is also $|0.0103 -
0.008|=0.0023$.
\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\linewidth]{ecc_power_spec.pdf}
  \caption{Power spectrum for eccentricity over the past 3 million years. There
...
[Here put the 65deg north summer solstice plot and do the power spectrum and
assess the roles of the different orbital params]
