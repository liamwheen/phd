...
%\begin{figure}
  %\centering
  %\includegraphics[width=0.6\linewidth]{land_distribution.pdf}
  %\caption{Percentage land distribution at each latitude (blue), with an
    %underlaid map of Earth. This map 
