...
present in the ice caps, the ocean is $^{18}$O rich. The $\delta^{18}$O ratio
within the foraminifera shells can therefore act as a good indication of global
ice volume over time. Importantly, a second factor that effects this ratio is
the temperature of the deep ocean water in which the foraminifera lived.
...
%
%---write about how the ice volume is related to the benthic, read and use (and ref)
%Elderfield, and explain the link. Then finish explaining the grey bars. Look at
%what we can deduce from the q_day_400k data, it seems that hot summers lead to
%more ice and vice versa? seems odd, maybe double check, if true, work out why
%that could happen and try to compare with yearly simulations
%
It is well understood that for approximately the past 1 million years,
a glacial-interglacial cycle has lasted around 100\,k years. This is correlated
with the period of Earth's eccentricity cycle. However, the relatively fast 
transition from glacial to interglacial periods also correlates to the amount of insolation present
during the northern hemisphere's summer. Because the Budyko model averages the
insolation over the year, the peak insolation during summer is
omitted from the current simulation.

Figure \ref{fig:Q65_benthic} shows the eccentricity of Earth's orbit over the
past 1 million years. Below this is the insolation on June 21$^{\mathrm{st}}$
at 65$^\circ$ north. Last is the benthic $\delta^{18}\mathrm{O}$ data with
the estimated deep see temperature shown on the opposite axis.

The grey bars highlight the periods over which a significant rise in
temperature has occurred in the $\delta^{18}\mathrm{O}$ plot. This highlights
the synchronisation of the temperature rises with eccentricity, with major rises
occurring approximately every 100\,k years. Also shown is the correlation
between summer insolation in the northern hemisphere and the temperature rises. 
